...
compile-dztech-dz60rgb-ansi-v2-via:
	docker run -it --rm -v ${CURDIR}/dztech-dz60rgb-ansi-v2-via:/qmk_firmware/keyboards/dztech/dz60rgb_ansi/keymaps/via-jonz94 qmkfm/qmk_firmware sh -c 'qmk compile -kb dztech/dz60rgb_ansi/v2 -km via-jonz94 && cp dztech_dz60rgb_ansi_v2_via-jonz94.hex /qmk_firmware/keyboards/dztech/dz60rgb_ansi/keymaps/via-jonz94/dztech-dz60rgb-ansi-v2-via-jonz94.hex'
